<template>
  <div class="detail">
    ...
    <div class="top">
      ...
      <div class="level">
        <svg t="1717145629070" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="2026" width="16" height="16">
          <path
      ...
      <div class="logo">
        ...
        <div class="right">
          <div class="address">
            <svg t="1717146173654" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="3193" width="16" height="16">
              <path
                ...
                fill="#3D3D3D" p-id="3194"></path>
            </svg>
            <span>具体的位置：{{ hospitalStore.hospitalInfo.hospital?.param.fullAddress }}</span>
            <div class="route">
